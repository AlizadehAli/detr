...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='kitti', help="coco OR kitti")
    parser.add_argument('--coco_path', type=str, default='/mnt/lustre/public_datasets/kitti')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # extra checkpoint before LR drop and every 100 epochs - now 10 epochs
        ...
        # test_stats, kitti_evaluator = evaluate(
        ...
        #         if "bbox" in kitti_evaluator.coco_eval:
        #             filenames = ['latest.pth']
        #             if epoch % 50 == 0:
        #                 filenames.append(f'{epoch:03}.pth')
        #             for name in filenames:
        #                 torch.save(kitti_evaluator.coco_eval["bbox"].eval,
